# Generated by Django 4.1.2 on 2022-11-04 20:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('component', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='StoreManagement.componentinstance')),
                ('scrapped_company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='StoreManagement.repaircompany')),
                ('shipped_condition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='StoreManagement.condition')),
                ('staff_shipped', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='StoreManagement.storestaff')),
            ],
        ),
        migrations.AddField(
